//
//  SSpawnMan.cs is part of Tunnelers: Unified
...
[RequireComponent (typeof (CSpawnMan))]

[AddComponentMenu ("Network/Spawn Man")]

public class SSpawnMan : MonoBehaviour {
	...
	GameObject Spawn (NetworkPlayer player, bool isBlue, string playerName) {
		...
		return GetComponent <SNetMan> ().RequestSpawn (player, prefab, pos, Quaternion.identity, playerName);
