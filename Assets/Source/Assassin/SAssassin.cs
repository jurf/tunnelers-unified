//
//  SAssassin.cs is part of Tunnelers: Unified
...
[RequireComponent (typeof (CAssassin))]

[AddComponentMenu ("Network/Assassin")]

public class SAssassin : MonoBehaviour {
	...
	public void Assassinate () {
		...
		foreach (GameObject flag in flags) {
			...
			flag.GetComponent <SFlagMan> ().DidICarryYou (parent.tank.gameObject);
